...
# updated code
# Create a SingleCellExperiment object instead of using 'newSCESet'
glom_570_sce <- SingleCellExperiment(assays = list(counts = glom_570_y),
                                     colData = infoFrame1)

# Calculate QC metrics
glom_570_sce <- calculateQCMetrics(glom_570_sce)
